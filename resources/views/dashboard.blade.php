...
<body class="g-sidenav-show bg-gray-200">
  ...
  <!-- Menu -->
  @include('dashboard_componentes.menu')
  ...
  <!-- Header -->
  @include('dashboard_componentes.header')
  
  <!-- Cerrar Header -->
  
  <!-- Titulo Corresponsabilidad -->
  @include('dashboard_componentes.titulo')
  
  <!-- Cerrar Titulo Corresponsabilidad -->
  
  <!-- Imagenes Niveles -->
  @include('dashboard_componentes.niveles')
  
  <!-- Cerrar Imagenes Niveles -->
  
  <!-- Gif Comentario -->
  @include('dashboard_componentes.gif_comentario')
  ...
  @include('dashboard_componentes.configuracion_colores')
